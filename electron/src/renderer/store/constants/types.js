const types = [
    ...
    'SWITCH_SETTING_DIALOG_STATUS_SYNC',
    'SWITCH_SETTING_DIALOG_STATUS', // 设置Dialog是否显示
    ...
    'TASKS_SWITCH_VIEW_TILES_IMG_VISIBLE_SYNC', // 控制预览瓦片图的弹窗是否显示
    'TASKS_SWITCH_VIEW_TILES_IMG_VISIBLE'
]
